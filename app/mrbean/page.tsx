  ...
  return (
    <div id="body">
      <div  className="max-w-[75%] mx-auto rounded-2xl border p-12 shadow-lg shadow-indigo-300/40 select-none space-y-8">
        <h1 className="text-3xl font-extrabold text-center">Mr. Bean&apos;s Teddy Keychain Pattern</h1>
        ...
        {'\n'}
        The finished teddy bear is about 10 cm (4″) long. Please note that the size of your work depends on yarn weight and hook size.{'\n'}
        {'\n'}
